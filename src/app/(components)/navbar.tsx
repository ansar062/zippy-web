  ...
  return (
    <div className=" backdrop-blur-sm bg-white/80 fixed top-0 w-full shadow-md">
      <nav className="md:pt-3 md:pl-10  lg:ml-[-4%] flex  justify-between sticky items-center   ">
        <Link href="../" className="pt-2 pr-[20%]  flex">
          <div className="absolute  md:hidden ml-4 mt-3 ">
            ...
            >
              <path
                d="M3.75 8.75H26.25M3.75 15H26.25M3.75 21.25H26.25"
                stroke="black"
                stroke-width="1.5"
          ...
          <img
            className=" w-[63px] h-[57px] mt-[-8px] md:ml-3 "
            src="logo.png"
            alt=""
          />
          <h1 className=" pl-4   text-[40px] font-extrabold font-primary italic">
            Zippy
          </h1>
        </Link>
        ...
        <button className="  bg-[#EB002B] rounded-[25px] h-[35px] w-[70px] text-[#FFF] font-sans ">
          <Link href="/Login">Login</Link>
        </button>
        <Link href='/ShoppingCart'><img
          className=" w-[63px] h-[57px] mt-[-8px] md:ml-2 mr-1 "
