...
export default  function LoginPage() {
  ...
  return (
    <div  className="min-w-full min-h-screen bg-[#FFD700]" >
      ...
      <div className={`mx-auto  mt-[23%] md:mt-[5rem] md:ml-[26%] bg-white  ml-[2.5rem]  rounded-lg w-[90%] md:w-[100%] lg:w-[50%] md:h-[70vh] h-[30rem]  justify-center  `}>
        ...
        <form className="ml-[15%] md:ml-[20%]">
          ...
          <a href='https://www.google.com' className='text-[#EB002B] underline hover:underline-offset-4 ml-[35%] pt-[20%] md:ml-[40%]'><Link href='ForgotPassword'>forgot password?</Link></a>
        </form>
        ...
        <div className='flex-row justify-center mt-2'>
          ...
          <h1 className='text-center pt-[2%]  pr-[4rem]  text-md text-gray-400'>if you don't have any account? <a className='text-[#EB002B] underline hover:underline-offset-4 absolute'><Link href='/Signup'>Signup</Link></a></h1>
        </div>
