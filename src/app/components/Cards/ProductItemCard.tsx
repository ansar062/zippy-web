...
export default function ProductItemCard(props: {imgUrl:String, name:String, desc:String, price:String}) {
    return (
        <motion.div
            ...
            className="bg-white drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)] w-[30rem] rounded-br-3xl rounded-bl-3xl px-[1rem] flex flex-col justify-center items-center">
            ...
            <h1 className="text-[32px] pt-2 font-bold ml-[-22rem]">Rs.{props.price}</h1>
