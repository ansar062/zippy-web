        ...
        <div className="flex min-h-screen bg-white">
            ...
            className="flex px-[20px] py-[2rem] space-y-[3rem] w-[80rem] text-black text-[40px] flex-col items-center bg-white">
                ...
                <div className="flex space-x-[15rem] flex-shrink justify-evenly">
                    <div className="flex justify-center items-center">
                        ...
                        <h1 className="text-[36px]">Mighty Zinger</h1>
                    </div>
                ...
                <div className="flex space-x-[15rem] flex-shrink justify-evenly">
                    ...
                    <motion.div
                        ...
                        >
                            <img src="images/screenshot-202308021130211.png" alt="" />
                        </motion.div>
                        
                        <h1 className="text-[36px]">Krunch Burger</h1>
                    </div>
                    <div className="flex justify-center items-center space-x-[15rem]">
                        <h1>1</h1>
                        <h1>300</h1>
                ...
                <div className="flex space-x-[15rem] flex-shrink justify-evenly">
                    ...
                    <motion.div
                        ...
                        <h1 className="text-[36px]">Rice N Chicken</h1>
                    </div>
                    <div className="flex justify-center items-center space-x-[15rem]">
                        <h1>1</h1>
                        <h1>500</h1>
            ...
            className="flex h-[51rem] px-[20px] space-y-[3rem] w-[40rem] text-white text-[40px] flex-col items-center bg-[#0F0808D4]">
                ...
                <div className="flex space-y-[0.5rem] flex-col justify-start items-start">
                    <h1>Promo Code</h1>
                    <input type="text" className="bg-[#D9D9D9] focus:text-black text-[36px] py-[0.5rem] px-[1rem] rounded-lg" placeholder="Enter Code" />
                    <motion.div
                        whileHover={{ scale: 1.1 }}
                        transition={{ type: "spring", stiffness: 400, damping: 10 }}
                    >
                        <input className="bg-[#EB002B] cursor-pointer py-[0.2rem] text-[36px] font-normal px-[1rem] rounded-full" type="button" value="Apply" />
                    </motion.div>
                </div>
                ...
                <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 400, damping: 10 }}
                >
                    <input className="cursor-pointer bg-[#EB002B] py-[0.5rem] mt-[2rem] text-[36px] font-normal px-[1rem] rounded-full" type="button" value="Proceed to Checkout" />
                </motion.div>
            </motion.div>
        </div>
    )
